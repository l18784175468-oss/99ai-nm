...
export class ModelsController {
  ...
  @Get('homePresets')
  @ApiOperation({ summary: '获取首页模型预设' })
  async getHomePresets() {
    return this.modelsService.getHomePresets();
  }
  
  @Post('setHomePresets')
  @ApiOperation({ summary: '设置首页模型预设' })
  @UseGuards(SuperAuthGuard)
  @ApiBearerAuth()
  setHomePresets(@Body() params: { presets: any[] }) {
    return this.modelsService.setHomePresets(params);
  }
